<nav class="bg-indigo-600"  x-data="{ isOpen: false, menuIsOpen: false }"  @keydown.escape="isOpen = false">
      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3" x-data="{dropdownMenu: false}">
              <div>
                <button type="button" @click="dropdownMenu = ! dropdownMenu" class="relative flex max-w-xs items-center rounded-full bg-indigo-600 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  <span class="absolute -inset-1.5"></span>
        ...
        >
          ...
          @click="menuIsOpen = !menuIsOpen"
           class="relative inline-flex items-center justify-center rounded-md bg-indigo-600 p-2 text-indigo-200 hover:bg-indigo-500 hover:bg-opacity-75 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600" aria-controls="mobile-menu" aria-expanded="false">
    ...
    >
      ...
      <div class="border-t border-indigo-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-indigo-500 hover:bg-opacity-75">Sign out</a>
